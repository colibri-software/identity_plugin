...
* Profile Model - model that will be used for a profile. Must have at least one field for the uid.
* Slug of the UID fiele - slug of the field in the Profile model used to store the uid.
* After Profile Updaet URL - url to go to after the profile update is complete.
